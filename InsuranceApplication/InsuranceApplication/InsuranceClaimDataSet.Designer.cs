...
namespace InsuranceApplication {
    ...
    public partial class InsuranceClaimDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/InsuranceClaimDataSet.xsd";
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(string firstname, string lastname, string username, string password, int rank, string creation, string claims) {
            ...
            private void InitClass() {
                ...
                this.columnclaims = new global::System.Data.DataColumn("claims", typeof(string), null, global::System.Data.MappingType.Element);
                ...
                this.columnclaims.MaxLength = 50;
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public string claims {
                get {
                    return ((string)(this[this.tableusers.claimsColumn]));
                }
                set {
...
namespace InsuranceApplication.InsuranceClaimDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_claims", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "claims", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[users] ([firstname], [lastname], [username], [password], [rank], [creation], [claims]) VALUES (@firstname, @lastname, @username, @password, @rank, @creation, @claims);
SELECT firstname, lastname, username, password, rank, creation, claims, id FROM users WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@claims", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "claims", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [firstname] = @firstname, [lastname] = @lastname, [username] = @username, [password] = @password, [rank] = @rank, [creation] = @creation, [claims] = @claims WHERE (([firstname] = @Original_firstname) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([rank] = @Original_rank) AND ([creation] = @Original_creation) AND ([claims] = @Original_claims) AND ([id] = @Original_id));
SELECT firstname, lastname, username, password, rank, creation, claims, id FROM users WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@claims", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "claims", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_claims", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "claims", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT firstname, lastname, username, password, rank, creation, claims, id FROM d" +
                "bo.users";
        ...
        public virtual int Delete(string Original_firstname, string Original_lastname, string Original_username, string Original_password, int Original_rank, string Original_creation, string Original_claims, long Original_id) {
            ...
            if ((Original_creation == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_creation));
            }
            if ((Original_claims == null)) {
                throw new global::System.ArgumentNullException("Original_claims");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_claims));
            }
        ...
        public virtual int Insert(string firstname, string lastname, string username, string password, int rank, string creation, string claims) {
            if ((firstname == null)) {
            ...
            if ((creation == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(creation));
            }
            if ((claims == null)) {
                throw new global::System.ArgumentNullException("claims");
            }
            else {
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(claims));
            }
        ...
        public virtual int Update(
            ...
            if ((creation == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(creation));
            }
            if ((claims == null)) {
                throw new global::System.ArgumentNullException("claims");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(claims));
            }
            if ((Original_firstname == null)) {
                throw new global::System.ArgumentNullException("Original_firstname");
            }
            ...
            if ((Original_creation == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_creation));
            }
            if ((Original_claims == null)) {
                throw new global::System.ArgumentNullException("Original_claims");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_claims));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string username, string password, int rank, string creation, string claims, string Original_firstname, string Original_lastname, string Original_username, string Original_password, int Original_rank, string Original_creation, string Original_claims, long Original_id) {
            return this.Update(firstname, lastname, username, password, rank, creation, claims, Original_firstname, Original_lastname, Original_username, Original_password, Original_rank, Original_creation, Original_claims, Original_id, Original_id);
        }
    }
